...
**file:** [developer_guide_and_architecture.md](developer_guide_and_architecture.md)
...
**file:** [model_catalog_and_routing_intelligence.md](model_catalog_and_routing_intelligence.md)
...
**file:** [history_reconstruction_and_context.md](history_reconstruction_and_context.md)
...
**file:** [multimodal_ingestion_pipeline.md](multimodal_ingestion_pipeline.md)
...
**file:** [task_models_and_housekeeping.md](task_models_and_housekeeping.md)
...
**file:** [tooling_and_integrations.md](tooling_and_integrations.md)
...
**file:** [streaming_pipeline_and_emitters.md](streaming_pipeline_and_emitters.md)
...
**file:** [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md)
...
**file:** [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md)
...
**file:** [testing_bootstrap_and_operations.md](testing_bootstrap_and_operations.md)
...
**file:** [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md)
...
**file:** [security_and_encryption.md](security_and_encryption.md)
...
**file:** [openrouter_integrations_and_telemetry.md](openrouter_integrations_and_telemetry.md)
...
**file:** [error_handling_and_user_experience.md](error_handling_and_user_experience.md)
...
### 4.5 request identifiers & abuse attribution
...
### 4.6 encrypted session log storage
...
1. Start with [developer_guide_and_architecture.md](developer_guide_and_architecture.md) to understand how the manifold is layered.
2. If you are touching model selection or capability toggles, read [model_catalog_and_routing_intelligence.md](model_catalog_and_routing_intelligence.md) followed by [history_reconstruction_and_context.md](history_reconstruction_and_context.md).
3. For multimodal or storage changes, pair [multimodal_ingestion_pipeline.md](multimodal_ingestion_pipeline.md) with [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md).
4. Tooling, streaming, or concurrency work should reference [tooling_and_integrations.md](tooling_and_integrations.md), [streaming_pipeline_and_emitters.md](streaming_pipeline_and_emitters.md), and [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md) respectively.
5. Always consult [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md) before adding or editing configuration knobs, and skim [testing_bootstrap_and_operations.md](testing_bootstrap_and_operations.md) before submitting PRs.
...
* Start: [developer_guide_and_architecture.md](developer_guide_and_architecture.md)
* Configuration: [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md)
* Model behavior: [model_catalog_and_routing_intelligence.md](model_catalog_and_routing_intelligence.md)
* Message handling: [history_reconstruction_and_context.md](history_reconstruction_and_context.md)
* Multimodal: [multimodal_ingestion_pipeline.md](multimodal_ingestion_pipeline.md)
* Tools: [tooling_and_integrations.md](tooling_and_integrations.md)
* Streaming: [streaming_pipeline_and_emitters.md](streaming_pipeline_and_emitters.md)
* Storage: [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md)
* Resilience: [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md)

**⚙️ Operator** (deploying, monitoring, troubleshooting):
* Start: [testing_bootstrap_and_operations.md](testing_bootstrap_and_operations.md)
* Pre-deploy: [production_readiness_report.md](production_readiness_report.md)
* Configuration: [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md)
* Errors: [error_handling_and_user_experience.md](error_handling_and_user_experience.md)
* Resilience: [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md)
* OpenRouter specifics: [openrouter_integrations_and_telemetry.md](openrouter_integrations_and_telemetry.md)

**🔒 Security** (securing, auditing, compliance):
* Start: [security_and_encryption.md](security_and_encryption.md)
* Audit: [production_readiness_report.md](production_readiness_report.md)
* SSRF: [multimodal_ingestion_pipeline.md](multimodal_ingestion_pipeline.md) (implementation details)
* Encryption: [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md) (key rotation)
* Configuration: [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md) (security valves)

**📋 Auditor** (verifying readiness, compliance):
* Start: [production_readiness_report.md](production_readiness_report.md)
* Security posture: [security_and_encryption.md](security_and_encryption.md)
* Configuration: [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md)
* Resilience: [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md)
...
|------|-------------|----------------|
| **Add new valve** | [valves_and_configuration_atlas.md](valves_and_configuration_atlas.md) | [developer_guide_and_architecture.md](developer_guide_and_architecture.md) |
| **Configure encryption** | [security_and_encryption.md](security_and_encryption.md) | [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md) |
| **Troubleshoot errors** | [error_handling_and_user_experience.md](error_handling_and_user_experience.md) | [openrouter_integrations_and_telemetry.md](openrouter_integrations_and_telemetry.md) |
| **Set up testing** | [testing_bootstrap_and_operations.md](testing_bootstrap_and_operations.md) | [developer_guide_and_architecture.md](developer_guide_and_architecture.md) |
| **Deploy to production** | [production_readiness_report.md](production_readiness_report.md) | [security_and_encryption.md](security_and_encryption.md), [testing_bootstrap_and_operations.md](testing_bootstrap_and_operations.md) |
| **Understand model routing** | [model_catalog_and_routing_intelligence.md](model_catalog_and_routing_intelligence.md) | [history_reconstruction_and_context.md](history_reconstruction_and_context.md) |
| **Handle multimodal content** | [multimodal_ingestion_pipeline.md](multimodal_ingestion_pipeline.md) | [persistence_encryption_and_storage.md](persistence_encryption_and_storage.md) |
| **Configure tools/MCP** | [tooling_and_integrations.md](tooling_and_integrations.md) | [concurrency_controls_and_resilience.md](concurrency_controls_and_resilience.md) |
